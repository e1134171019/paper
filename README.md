...
> Current 2026-08-20 mainline: File 62 returned to the raw ASP-2000 R52 SchDoc and closed several A0-real post-X1 identities that Files60–61 had intentionally left open. The schematic design identifies `D1/D2/D5/D6 = KSU60D60N` 600-V/60-A fast-recovery silicon diodes; the 220-V X3 population is `8 × IRG7PH35UDPBF` 1200-V trench IGBTs arranged as four H-bridge switch positions with two parallel IGBTs per position; and `C8/C11/C89/C90 = 680 µF / 315 V` are all connected across the same `BUS+ ↔ BUS-`, giving `2720 µF` schematic passive-X2 capacitance. This creates a mandatory dual ledger: `A0-REAL R52` for legacy-product loss localization and `A0-MODERN-MATCHED` for topology fairness. Legacy FRD/IGBT savings may not be claimed as topology savings. Actual X3 PWM carrier/modulation, actual BUS voltage, HFT DCR/Rac/secondary-RMS, capacitor ESR, and physical-unit population remain open. Therefore `E4+E6` remains a high-interest physical-modernization target but only a conditional/comparator new-topology branch. Immediate next is File63: close X3 switching/carrier and HFT copper/RMS evidence before selecting E4+E6, E2, or no-new-topology as the next research mainline. Candidate #10 remains `HOLD / NOT_ASSIGNED`; novelty remains `NOT_ESTABLISHED`; PSIM/LTspice/hardware are not executed.
